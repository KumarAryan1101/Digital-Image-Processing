...
import os
import threading
from shannon_fano_coding import process_shannon_fano

class ShannonFanoApp:
    def __init__(self, root):
        self.root = root
        self.root.title("Manual Shannon-Fano Coding")
    ...
    def setup_ui(self):
        ...
        tk.Button(btn_frame, text="Encode with Shannon-Fano", command=self.process_image, font=("Arial", 11)).grid(row=0, column=1, padx=10)
    ...
    def process_image(self):
        ...
        def run_task():
            try:
                metrics = process_shannon_fano(self.image_path, self.output_dir)
    ...
    def display_results(self, metrics):
        ...
        images_to_show = [
            ("Original Greyscale", "shannon_fano_original_grey.png"),
            ("Decoded (Lossless)", "shannon_fano_decoded.png"),
            ("Bit-Length Map", "shannon_fano_bit_length_map.png"),
            ("Length Distribution", "shannon_fano_length_distribution.png"),
            ("Metrics Summary", "shannon_fano_metrics_summary.png")
        ]
